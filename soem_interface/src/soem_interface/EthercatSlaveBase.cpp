...
template bool EthercatSlaveBase::sendSdoWrite<std::string>(const uint16_t index, const uint8_t subindex,
...
template bool EthercatSlaveBase::sendSdoRead<std::string>(const uint16_t index, const uint8_t subindex,
                                                          const bool completeAccess, std::string& value);
template bool EthercatSlaveBase::sendSdoRead<bool>(const uint16_t index, const uint8_t subindex,
                                                   const bool completeAccess, bool& value);
template bool EthercatSlaveBase::sendSdoRead<std::array<uint, 4>>(const uint16_t index, const uint8_t subindex,
